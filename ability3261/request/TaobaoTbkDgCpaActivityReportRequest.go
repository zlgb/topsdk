...
func (s *TaobaoTbkDgCpaActivityReportRequest) SetPageNo(v int64) *TaobaoTbkDgCpaActivityReportRequest {
    s.PageNo = &v
    return s
}
func (s *TaobaoTbkDgCpaActivityReportRequest) SetQueryType(v int64) *TaobaoTbkDgCpaActivityReportRequest {
    s.QueryType = &v
    return s
}
func (s *TaobaoTbkDgCpaActivityReportRequest) SetPageSize(v int64) *TaobaoTbkDgCpaActivityReportRequest {
    s.PageSize = &v
    return s
}
