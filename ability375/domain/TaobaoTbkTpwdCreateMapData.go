...
func (s *TaobaoTbkTpwdCreateMapData) SetPasswordSimple(v string) *TaobaoTbkTpwdCreateMapData {
    s.PasswordSimple = &v
    return s
}
func (s *TaobaoTbkTpwdCreateMapData) SetModel(v string) *TaobaoTbkTpwdCreateMapData {
    s.Model = &v
    return s
}
