...
func (s *TaobaoTbkDgTpwdRiskReportRequest) SetOffset(v int64) *TaobaoTbkDgTpwdRiskReportRequest {
    s.Offset = &v
    return s
}
func (s *TaobaoTbkDgTpwdRiskReportRequest) SetLimit(v int64) *TaobaoTbkDgTpwdRiskReportRequest {
    s.Limit = &v
    return s
}
